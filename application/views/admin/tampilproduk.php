				...
				<table class="table" id="tabelku">
					...
					<!-- karena data banyak dan array , ditampilkan pakai foreach -->
						...
						<td>
							...
							<a href="<?php echo base_url("admin/produk/ubah/$value[id_produk]") ?>" class="btn btn-warning btn-sm">ubah</a>
							<a href="<?php echo base_url("admin/produk/hapus/$value[id_produk]") ?>" class="btn btn-danger btn-sm">hapus</a>
						</td>
						<?php endforeach ?>
						</tr>
					</tbody>
